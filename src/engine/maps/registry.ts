...
export const MAP_REGISTRY: MapInfo[] = [
  ...
  },
  {
    ...
    description: "The colonial partition of Africa — 40 territories.",
    factionIds: ["britain", "france", "germany", "italy", "portugal", "belgium", "ethiopia", "boers", "egypt"],
    startPositions: {
      morocco: "france", algeria: "france", tunisia: "france", mauritania: "france",
      senegal: "france", guinea: "france", mali: "france", "ivory-coast": "france",
      "burkina-faso": "france", niger: "france", chad: "france", gabon: "france",
      "congo-brazzaville": "france", "central-african-rep": "france", madagascar: "france",
      sudan: "britain", "south-sudan": "britain", nigeria: "britain", ghana: "britain",
      "sierra-leone": "britain", uganda: "britain", kenya: "britain", zambia: "britain",
      zimbabwe: "britain", botswana: "britain", cape: "britain",
      "togo-benin": "germany", cameroon: "germany", "rwanda-burundi": "germany",
      tanzania: "germany", namibia: "germany",
      libya: "italy", eritrea: "italy", somalia: "italy",
      congo: "belgium",
      angola: "portugal", mozambique: "portugal",
      ethiopia: "ethiopia",
      "boer-republics": "boers",
      egypt: "egypt",
    },
