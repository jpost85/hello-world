...
const NEAR_EAST = {
  ...
  outFile: "nearEast.ts",
  crop: { lngMin: 18, lngMax: 60, latMin: 12, latMax: 42 },
  landThreshold: 0.2,
  simplifyTerritory: 0.5,
  regions: [
  ...
  spec: [
    ...
    { id: "cyprus", name: "Cyprus", region: "levant", countries: ["Cyprus", "Northern Cyprus"] },
    ...
    { id: "greece", name: "Greece", region: "anatolia", countries: ["Greece"] },
