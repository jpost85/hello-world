...
(function () {
  ...
  const REGION_DEFS = [
    ...
    // Neutral frontier — unclaimed lands either side may seize and use.
    { id: "ohio",      name: "Ohio Country",   x: 120, y: 400, income: 4,  city: false, capital: false },
    { id: "appalachia",name: "Appalachia",     x: 196, y: 473, income: 3,  city: false, capital: false },
    { id: "florida",   name: "East Florida",   x: 143, y: 872, income: 4,  city: true,  capital: false },
  ];
  ...
  const ADJACENCY = {
    ...
    nj:     ["ny", "penn", "del"],
    penn:   ["ny", "nj", "md", "del", "ohio", "appalachia"],
    del:    ["nj", "penn", "md"],
    md:     ["penn", "del", "va", "appalachia"],
    va:     ["md", "nc", "appalachia"],
    nc:     ["va", "sc", "appalachia"],
    sc:     ["nc", "ga"],
    ga:     ["sc", "florida"],
    // Frontier adjacency
    ohio:       ["penn", "appalachia"],
    appalachia: ["penn", "md", "va", "nc", "ohio"],
    florida:    ["ga"],
  };
