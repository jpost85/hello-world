...
// Usage: npm run standalone  ->  dist-standalone/overshot.html
...
<title>Overshot — Artillery Duel</title>
<style>
${css}
</style>
</head>
...
const outFile = new URL("overshot.html", outDir);
writeFileSync(outFile, html);
const kb = (html.length / 1024).toFixed(1);
console.log(`wrote dist-standalone/overshot.html (${kb} KB) — open it in any browser.`);
